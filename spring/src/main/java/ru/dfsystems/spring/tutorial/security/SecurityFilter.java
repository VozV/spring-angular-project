...
import static ru.dfsystems.spring.tutorial.security.CookieUtils.COOKIE_MAX_AGE;
    ...
    private boolean isAuthRequest(Cookie userCookie) {
        if (userCookie != null && userCookie.getValue() != null && !userCookie.getValue().isEmpty()) {
            ...
            if (user != null && user.getIsActive() &&
                    user.getLastLoginDate().isAfter(LocalDateTime.now().minus(COOKIE_MAX_AGE, SECONDS))) {
